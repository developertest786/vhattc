...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>" >
	<head>
        ...
        <script type="text/javascript" src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template; ?>/js/jquery-ui-1.9.2.custom.min.js"></script>
...
<div id="all" class="main-layout">
    ...
    <?php if ($isAboutPage) :?>
        <div id="about-page" class="row l260 faux-left-gray fixCenter1K">
                ...
                <!-- quick nav -->
                <jdoc:include type="modules" name="about-us-menu" />
                <!-- end quick nav -->
            </div>
