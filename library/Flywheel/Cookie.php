...
class Cookie {
	 ...
	 * 
	 * @param string	$name
	 * @param integer	$type Ming_Filter::TYPE_* @see Ming_Filter
	 * @param mixed		$default
	 * 
	 * @return mixed
	 */
	 ...
	 * if cookie_exception turn on @throw new Ming_Exception when timestamp and signature not valid
	 * 
	 * @param string	$name
	 * @param integer	$type
	 * @param mixed		$default
	 ...
	 * @throws Ming_Exception
	 */
	public function readSecure($name, $type = Ming_Filter::TYPE_STRING, $default = null) {
		...
		if ($value[1] > time()) {
			if (true == $this->_exception) {
				throw new Ming_Exception('Invalid cookie timestamp!');
			}
			return null;
		}
