...
class Dispatcher implements IDispatcher
{
     ...
     * @api
     */
    public function dispatch($eventName, \Flywheel\Event\Common $event = null)
    {
        if (null === $event) {
            $event = new \Flywheel\Event\Common();
        }
     ...
     * @param \Flywheel\Event\Common $event The event object to pass to the event handlers/listeners.
     */
    protected function doDispatch($listeners, $eventName, \Flywheel\Event\Common $event)
    {
