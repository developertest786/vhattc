...
(function($){
	...
	$.tiny.carousel = {
		options: {
            ...
            easingEffect: "linear", // how fast must the animation move in ms?
			onStart: null, // function that executes after every move.
		...
		this.move = function(iDirection, bPublic){
			...
			if(iCurrent > -1 && iCurrent < iSteps){
                ...
                if(typeof options.onStart == 'function')
                    options.onStart.call(this, oPages[iCurrent], iCurrent);
